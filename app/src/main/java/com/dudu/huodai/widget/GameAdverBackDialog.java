...
public class GameAdverBackDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_adverback);
...
//如果对话框宽度异常，可以通过下方代码根据设备的宽度来设置弹窗宽度
        ...
        CheckBox an1 = (CheckBox) findViewById(R.id.answer_first);
        ...
        if(!TextUtils.isEmpty(anSwer)){
            ...
            an1.setText(anSwer.substring(0,1));
            an2.setText(anSwer.substring(1,2));
            an3.setText(anSwer.substring(2,3));
            an4.setText(anSwer.substring(3,4));
        }
